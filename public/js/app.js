...
function listeners() {
	...
	var messageCardNodeList = document.querySelectorAll('.messageCard>button');
...
function decryptMessage(e) {
	var messageId = parseInt(e.target.dataset.id, 10);
	//console.log(e.target.parentNode.getElementsByTagName('input')[0].value);
	var offset = e.target.parentNode.getElementsByTagName('input')[0].value;
